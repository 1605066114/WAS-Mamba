...
def main(config):
    ...
    outputsforepoch= os.path.join(config.work_dir, 'outputsforepoch')
    if not os.path.exists(checkpoint_dir):
        os.makedirs(checkpoint_dir)
    if not os.path.exists(outputs):
        os.makedirs(outputs)
    if not os.path.exists(outputsforepoch):
        os.makedirs(outputsforepoch)
    ...
    train_sampler = DistributedSampler(train_dataset, shuffle=False) if config.distributed else None
    ...
    if os.path.exists(os.path.join(checkpoint_dir, 'best.pth')):
        ...
        #     logger,
        #     config,
        #     test_save_path=outputsforepoch,
        #     val_or_test=True
        # )
        # # os.rename(
        # #     os.path.join(checkpoint_dir, 'best.pth'),
